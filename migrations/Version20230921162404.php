 ...
 */
final class Version20230921162404 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE billet (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, paiement_id INT NOT NULL, prix DOUBLE PRECISION NOT NULL, paye TINYINT(1) NOT NULL, nom_prenom_passager VARCHAR(255) NOT NULL, INDEX IDX_1F034AF6A76ED395 (user_id), UNIQUE INDEX UNIQ_1F034AF62A4C4478 (paiement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
